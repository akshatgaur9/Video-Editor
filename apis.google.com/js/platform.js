(function() {
    ...
    */
    ...
    /*
     ...
     SPDX-License-Identifier: Apache-2.0
    */
    var za = "src srcdoc codebase data href rel action formaction sandbox icon".split(" ");
    var Aa = {};
    ...
    var L = function(a, b, c) {
        ...
        Cb = function(a, b) {
            ...
            if (e.nodeType === 1 && (b = e.tagName, /^(script|style)$/i.test(b))) throw d = b.toLowerCase() === "script" ? "Use setScriptTextContent with a SafeScript." : "Use setStyleTextContent with a SafeStyleSheet.",
                Error(d);
    ...
    window.gapi.load("", {
        ...
        _c: {
            ...
            jsl: {
                ...
                h: "m;/_/scs/abc-static/_/js/k=gapi.lb.en.z-CF99wuLeU.O/d=1/rs=AHpOoo8yJLmK2FeQzRT4hxPn9_NEJo9eCg/m=__features__",
